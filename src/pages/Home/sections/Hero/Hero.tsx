                ...
                <Container maxWidth="lg">
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={7}>
                            <Typography color="primary.contrastText" variant="h1" textAlign="center" pb={2}>Kevin Abreu</Typography>
                            <Typography color="primary.contrastText" variant="h2" textAlign="center">I`m a Devoloper Backend</Typography>
